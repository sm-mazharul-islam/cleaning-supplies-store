    ...
    <Container>
      <div className="py-10 px-4 sm:px-6 lg:px-8 max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl text-slate-900 dark:text-white tracking-tight uppercase">
          ...
          <Link href="/dashboard/addProduct" className="w-full md:w-auto">
            <button className="w-full flex items-center justify-center gap-2 rounded-2xl bg-slate-900 dark:bg-blue-600 px-6 py-4 text-xs font-black uppercase tracking-widest text-white shadow-xl hover:opacity-90 active:scale-95 transition-all">
        ...
        <div className="grid grid-cols-1 gap-6 md:hidden mb-10">
          {allSupply.map((item) => (
            <div
              key={item._id}
              className="bg-white dark:bg-slate-900 p-5 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-lg"
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="relative w-16 h-16 rounded-2xl overflow-hidden border dark:border-slate-700 bg-slate-50 dark:bg-slate-800">
                  <Image
                    src={
                ...
                <div className="flex-1">
                  ...
                  <span className="text-[9px] font-black uppercase bg-blue-50 dark:bg-blue-900/30 text-blue-600 px-2 py-1 rounded mt-1 inline-block">
              ...
              <div className="flex justify-between items-center pt-4 border-t dark:border-slate-800">
                ...
                <div className="flex gap-2">
                  <Link
                    ...
                    className="p-3 bg-slate-50 dark:bg-slate-800 rounded-xl text-slate-400 hover:text-blue-600"
                  >
                    <FaEdit size={16} />
                  </Link>
                ...
                >
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-4">
                      <div className="relative w-12 h-12 rounded-xl bg-slate-100 dark:bg-slate-800 overflow-hidden border dark:border-slate-700">
                        <Image
                          src={
                            Array.isArray(item.image)
                              ? item.image[0]
